...
public class certificationService {
	...
	public static void certifiedPhoneNumber(String phoneNumber, String cerNum) {
        ...
        String api_key = "NCSGDJKJR5T1CT9Q";
        String api_secret = "MW5M0JJMQI87HZSNMDMFLUAOABFLVNLG";
        Message coolsms = new Message(api_key, api_secret);
        // 4 params(to, from, type, text) are mandatory. must be filled
        HashMap<String, String> params = new HashMap<String, String>();
        params.put("to", phoneNumber);    // 수신전화번호
        params.put("from", "01087836065");    // 발신전화번호. 테스트시에는 발신,수신 둘다 본인 번호로 하면 됨
        params.put("type", "SMS");
        params.put("text", "Show Me 휴대폰인증 테스트 메시지 : 인증번호는" + "["+cerNum+"]" + "입니다.");
